// Plik pobrany ze strony https://www.mimuw.edu.pl/~marpe/mikrokontrolery/pozosta%c5%82e/i2c_init.c
// Autorstwa doktora Marcina Peczarskiego
...
void i2c_init(unsigned pclk) {
    ...
    I2C_SCL_HIGH();
    I2C_SDA_HIGH(); // NACK
    GPIOoutConfigure(I2C_GPIO, I2C_SCL_PIN, GPIO_OType_OD, GPIO_Low_Speed, GPIO_PuPd_NOPULL);
    GPIOoutConfigure(I2C_GPIO, I2C_SDA_PIN, GPIO_OType_OD, GPIO_Low_Speed, GPIO_PuPd_NOPULL);
    ...
    GPIOafConfigure(I2C_GPIO, I2C_SCL_PIN, GPIO_OType_OD, GPIO_Low_Speed, GPIO_PuPd_NOPULL,
                    GPIO_AF_I2C1);
    GPIOafConfigure(I2C_GPIO, I2C_SDA_PIN, GPIO_OType_OD, GPIO_Low_Speed, GPIO_PuPd_NOPULL,
                    GPIO_AF_I2C1);
